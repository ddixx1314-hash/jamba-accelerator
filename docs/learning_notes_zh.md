...
英文含义：小型 4x4 GEMM，也就是小型 4x4 矩阵乘法。
...
英文含义：RMSNorm Statistics，RMSNorm 统计量。
...
英文含义：RMSNorm Approximation，RMSNorm 近似实现。
...
英文含义：4-lane Linear Projection，4 路线性投影。
...
英文含义：Mamba State Update，Mamba 状态更新。
...
英文含义：1D Causal Convolution，一维因果卷积。
...
英文含义：Tiny Selective Scan，小型选择性扫描。
...
英文含义：Tiny Attention Decode，小型 Attention 解码。
...
英文含义：Tiny Mamba Block，小型 Mamba 模块。
...
英文含义：Tiny Jamba Block，小型 Jamba 模块。
...
英文含义：Jamba 2 Mini Accelerator，Jamba 2 小型加速器。
...
英文含义：Jamba 2 Mini Core，Jamba 2 小型核心计算模块。
...
英文含义：Jamba 2 Mini Stream，带流式握手接口的 Jamba 2 小型模块。
...
英文含义：Generate Verilog，生成 Verilog/SystemVerilog。
