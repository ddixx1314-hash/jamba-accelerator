...
class SharedDenseMLPMiniSpec extends AnyFlatSpec with ChiselScalatestTester {
  behavior of "SharedDenseMLPMini"
  ...
  it should "match the deterministic dense MLP fixture" in {
    test(new SharedDenseMLPMini()) { dut =>
