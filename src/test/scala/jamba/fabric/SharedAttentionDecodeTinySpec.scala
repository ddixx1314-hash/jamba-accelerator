...
class SharedAttentionDecodeTinySpec extends AnyFlatSpec with ChiselScalatestTester {
  behavior of "SharedAttentionDecodeTiny"
  ...
  it should "compute dot-product scores and weighted value sums" in {
    test(new SharedAttentionDecodeTiny()) { dut =>
