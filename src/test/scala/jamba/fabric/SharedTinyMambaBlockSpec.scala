...
class SharedTinyMambaBlockSpec extends AnyFlatSpec with ChiselScalatestTester {
  behavior of "SharedTinyMambaBlock"
  ...
  it should "combine shared convolution, SSM state, and residual gate" in {
    test(new SharedTinyMambaBlock()) { dut =>
