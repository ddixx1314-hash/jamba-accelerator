...
/** Jamba2 mini Mamba mixer: input projection, causal conv, token-serial scan, and C gate. */
class Jamba2MambaMixerMini(lanes: Int = 4, taps: Int = 4, dataWidth: Int = 8, stateWidth: Int = 32, accWidth: Int = 32)
    extends Module {
  require(lanes == 4, "Jamba2MambaMixerMini currently uses Linear4 and requires lanes == 4")
  require(taps > 0, "Jamba2MambaMixerMini taps must be positive")
